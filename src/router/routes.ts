...
import { expressAuthentication } from './../secure';
...
const models: TsoaRoute.Models = {
    ...
    "Pagination": {
        ...
        "properties": {
            ...
            "take": {"dataType":"double","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/users/new',
            authenticateMiddleware([{"jwt":["mutate-user"]}]),
            ...(fetchMiddlewares<RequestHandler>(UserController)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/users',
            authenticateMiddleware([{"jwt":["get-user"]}]),
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.userList)),

            function UserController_userList(request: any, response: any, next: any) {
            const args = {
                    filter: {"in":"body","name":"filter","required":true,"ref":"UserFilter"},
            };
        ...
        app.post('/users/reg',
            ...(fetchMiddlewares<RequestHandler>(UserController)),
            ...(fetchMiddlewares<RequestHandler>(UserController.prototype.userRegistration)),
            ...
            try {
              ...
              const promise = controller.userRegistration.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/users/login',
            ...
            const args = {
                    user: {"in":"body","name":"user","required":true,"ref":"Pick_User.email-or-password_"},
                    error: {"in":"res","name":"400","required":true,"dataType":"string"},
            };
